...
public class opcionesPreguntaM extends HttpServlet { //Public es un modificador de clase, no es modificador de acceso
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)//Protected en este caso si es un modificador de acceso, HTTPServelet son parámetros de entrada: request es de lado clienteservidor, response, el servidor WEB es el que proporciona los objetos request y response
        ...
        String tipo = (String) session.getAttribute("tipo"); //Recuperamos el atributo de tipo.
        ...
        out.println("<br><br>");
        out.println("<button id='button' form='fo' name='boton' formaction='Preguntas' type='submit' value='multiplechoice' >");//Creamos un boton para mandar la informacion.
        out.println("guardar");
        out.println("</button>");
        out.println("</form>");
