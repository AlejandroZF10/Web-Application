    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(archivo.exists()) {
                ...
                out.println("<button class='mdc-button mdc-button--outlined' name='opcion' type='submit' onclick=\"location.href='FillInBlankAudio'\">Regresar</button>");
                out.println("</div>");
                out.println("</body>");
                out.println("</html>");
            }else{
                ...
                out.println("<form action='XMLAudioFill1' method='get'>");
