    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                out.println("</div>");
                out.println("</table></br><input type='text' name='correct' size='100'></br>");
                out.println("<video width=\"420\" height=\"340\" controls autoplay>");
                out.println("<source src = "+multimedia+" type = audio/mp4></br>");
