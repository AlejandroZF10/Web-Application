...
public class FalloLogin extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<div class='divisor' >");
                out.println("<h1 class='fuente'>You're not authenticated. Login again please.</h1>");
                out.println("<button class='mdc-button mdc-button--outlined' onclick=\"location.href='Login.html'\">Salir</button>");
            out.println("</body>");
            out.println("</html>");
        }
    }
