...
public class FillInBlankText extends HttpServlet {
     @Override
     protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()){
            ...
            out.println("</br></br><button name='button1' class='mdc-button mdc-button--outlined' \">Texto</button>");
            out.println("<button name='button4' disabled class='mdc-button mdc-button--outlined'\">Audio</button>");
            out.println("<button name='button2' disabled class='mdc-button mdc-button--outlined'\">Imagen</button>");
            out.println("<button name='button3' disabled class='mdc-button mdc-button--outlined'\">Video</button>");
